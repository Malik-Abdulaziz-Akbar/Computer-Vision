...
% Last Modified by GUIDE v2.5 18-Nov-2019 12:59:11
...
Low_Threshold=getappdata(0,'Low_Threshold');
High_Threshold=getappdata(0,'High_Threshold');
myImage=CannyAlgo(myImage,Low_Threshold,High_Threshold);
imshow(myImage);
